 ...
 * The macros are prefixed with 'PIO_ACCEL_Z_'.
 * The prefix is the slave descriptor.
 */
...
#define PIO_ACCEL_Z_DATA_WIDTH 16
#define PIO_ACCEL_Z_DO_TEST_BENCH_WIRING 0
#define PIO_ACCEL_Z_DRIVEN_SIM_VALUE 0
#define PIO_ACCEL_Z_EDGE_TYPE NONE
#define PIO_ACCEL_Z_FREQ 50000000
#define PIO_ACCEL_Z_HAS_IN 1
#define PIO_ACCEL_Z_HAS_OUT 0
#define PIO_ACCEL_Z_HAS_TRI 0
#define PIO_ACCEL_Z_IRQ_TYPE NONE
#define PIO_ACCEL_Z_RESET_VALUE 0

/*
 * Macros for device 'pio_accel_y', class 'altera_avalon_pio'
 * The macros are prefixed with 'PIO_ACCEL_Y_'.
 * The prefix is the slave descriptor.
 */
...
#define PIO_ACCEL_Y_DATA_WIDTH 16
#define PIO_ACCEL_Y_DO_TEST_BENCH_WIRING 0
#define PIO_ACCEL_Y_DRIVEN_SIM_VALUE 0
#define PIO_ACCEL_Y_EDGE_TYPE NONE
#define PIO_ACCEL_Y_FREQ 50000000
#define PIO_ACCEL_Y_HAS_IN 1
#define PIO_ACCEL_Y_HAS_OUT 0
#define PIO_ACCEL_Y_HAS_TRI 0
#define PIO_ACCEL_Y_IRQ_TYPE NONE
#define PIO_ACCEL_Y_RESET_VALUE 0

/*
 * Macros for device 'pio_accel_x', class 'altera_avalon_pio'
 * The macros are prefixed with 'PIO_ACCEL_X_'.
 * The prefix is the slave descriptor.
 */
...
#define PIO_ACCEL_X_DATA_WIDTH 16
#define PIO_ACCEL_X_DO_TEST_BENCH_WIRING 0
#define PIO_ACCEL_X_DRIVEN_SIM_VALUE 0
#define PIO_ACCEL_X_EDGE_TYPE NONE
#define PIO_ACCEL_X_FREQ 50000000
#define PIO_ACCEL_X_HAS_IN 1
#define PIO_ACCEL_X_HAS_OUT 0
#define PIO_ACCEL_X_HAS_TRI 0
#define PIO_ACCEL_X_IRQ_TYPE NONE
#define PIO_ACCEL_X_RESET_VALUE 0
