...
module soc_system_mm_interconnect_0 (
	...
	wire  [129:0] pio_accel_x_s1_agent_rf_source_data;                                                // pio_accel_x_s1_agent:rf_source_data -> pio_accel_x_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] pio_accel_x_s1_agent_rsp_fifo_out_data;                                             // pio_accel_x_s1_agent_rsp_fifo:out_data -> pio_accel_x_s1_agent:rf_sink_data
	...
	wire  [129:0] pio_accel_y_s1_agent_rf_source_data;                                                // pio_accel_y_s1_agent:rf_source_data -> pio_accel_y_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] pio_accel_y_s1_agent_rsp_fifo_out_data;                                             // pio_accel_y_s1_agent_rsp_fifo:out_data -> pio_accel_y_s1_agent:rf_sink_data
	...
	wire  [129:0] pio_accel_z_s1_agent_rf_source_data;                                                // pio_accel_z_s1_agent:rf_source_data -> pio_accel_z_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] pio_accel_z_s1_agent_rsp_fifo_out_data;                                             // pio_accel_z_s1_agent_rsp_fifo:out_data -> pio_accel_z_s1_agent:rf_sink_data
	...
	wire  [129:0] pio_pwm_s1_agent_rf_source_data;                                                    // pio_pwm_s1_agent:rf_source_data -> pio_pwm_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] pio_pwm_s1_agent_rsp_fifo_out_data;                                                 // pio_pwm_s1_agent_rsp_fifo:out_data -> pio_pwm_s1_agent:rf_sink_data
	...
	wire  [128:0] pio_accel_x_s1_agent_rp_data;                                                       // pio_accel_x_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [128:0] pio_accel_y_s1_agent_rp_data;                                                       // pio_accel_y_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [128:0] pio_accel_z_s1_agent_rp_data;                                                       // pio_accel_z_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [128:0] pio_pwm_s1_agent_rp_data;                                                           // pio_pwm_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_accel_x_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // pio_accel_x_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_accel_x_s1_burst_adapter:sink0_channel
	...
	wire  [128:0] pio_accel_x_s1_burst_adapter_source0_data;                                          // pio_accel_x_s1_burst_adapter:source0_data -> pio_accel_x_s1_agent:cp_data
	wire          pio_accel_x_s1_burst_adapter_source0_ready;                                         // pio_accel_x_s1_agent:cp_ready -> pio_accel_x_s1_burst_adapter:source0_ready
	wire    [7:0] pio_accel_x_s1_burst_adapter_source0_channel;                                       // pio_accel_x_s1_burst_adapter:source0_channel -> pio_accel_x_s1_agent:cp_channel
	...
	wire  [128:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_accel_y_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                              // pio_accel_y_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_accel_y_s1_burst_adapter:sink0_channel
	...
	wire  [128:0] pio_accel_y_s1_burst_adapter_source0_data;                                          // pio_accel_y_s1_burst_adapter:source0_data -> pio_accel_y_s1_agent:cp_data
	wire          pio_accel_y_s1_burst_adapter_source0_ready;                                         // pio_accel_y_s1_agent:cp_ready -> pio_accel_y_s1_burst_adapter:source0_ready
	wire    [7:0] pio_accel_y_s1_burst_adapter_source0_channel;                                       // pio_accel_y_s1_burst_adapter:source0_channel -> pio_accel_y_s1_agent:cp_channel
	...
	wire  [128:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_accel_z_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                              // pio_accel_z_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> pio_accel_z_s1_burst_adapter:sink0_channel
	...
	wire  [128:0] pio_accel_z_s1_burst_adapter_source0_data;                                          // pio_accel_z_s1_burst_adapter:source0_data -> pio_accel_z_s1_agent:cp_data
	wire          pio_accel_z_s1_burst_adapter_source0_ready;                                         // pio_accel_z_s1_agent:cp_ready -> pio_accel_z_s1_burst_adapter:source0_ready
	wire    [7:0] pio_accel_z_s1_burst_adapter_source0_channel;                                       // pio_accel_z_s1_burst_adapter:source0_channel -> pio_accel_z_s1_agent:cp_channel
	...
	wire  [128:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> pio_pwm_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                              // pio_pwm_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> pio_pwm_s1_burst_adapter:sink0_channel
	...
	wire  [128:0] pio_pwm_s1_burst_adapter_source0_data;                                              // pio_pwm_s1_burst_adapter:source0_data -> pio_pwm_s1_agent:cp_data
	wire          pio_pwm_s1_burst_adapter_source0_ready;                                             // pio_pwm_s1_agent:cp_ready -> pio_pwm_s1_burst_adapter:source0_ready
	wire    [7:0] pio_pwm_s1_burst_adapter_source0_channel;                                           // pio_pwm_s1_burst_adapter:source0_channel -> pio_pwm_s1_agent:cp_channel
